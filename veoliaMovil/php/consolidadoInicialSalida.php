...
//Sentencia
$sql = "SELECT  MATERIALES_DESCRIPCION, CATEGORIA, PyG, SUM(CANT_SALIDA)as CANT_SALIDA_TOTAL, UNIDAD FROM ordenes_salida WHERE FECHA_PESAJE>= '1950/01/01' AND FECHA_PESAJE<= '3000/01/01' GROUP BY materiales_descripcion";
